  ...
  <div class="create-post">
    ...
    <div class="container">
      ...
      <div class="blog-actions">
        <button @click="updateBlog">Sav Changes</button>
        <router-link class="router-button" :to="{name: 'Preview'}">Preview Changes</router-link>
      </div>
    </div>
  </div>
</template>
...
// const app = initializeApp(firebaseConfig);
    ...
    async updateBlog() {
      ...
      this.error = true
      this.errorMsg = 'please ensure the blog title or blog html filled !'
      setTimeout(() => {
        this.error = false
      }, 5000);
      return
